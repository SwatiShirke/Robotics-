...
S = [0 0 1 0 0 0;-1 0 0 0 -0.3 0;-1 0 0 0 -0.3 0.3;  0 0 1 0.6 0 0; -1 0 0 0 -0.3 0.6; 0 1 0 -0.3 0 0;]';
...
% home configuration
M = [0 1 0 0;0 0 1 0.6;1 0 0 0.3; 0 0 0 1];
...
for ii = 1 : nTests
    ...
    while norm(targetPose - currentPose) > 1e-3
        ...
        error(iteration) = norm(targetPose - currentPose);
